 ...
 */
final class Version20251203171259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "transaction" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, main_type VARCHAR(255) NOT NULL, category VARCHAR(50) NOT NULL, amount DOUBLE PRECISION NOT NULL, description VARCHAR(128) DEFAULT NULL, date DATETIME NOT NULL)');
